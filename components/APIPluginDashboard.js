        ...
        <div className="space-y-6">
          ...
          {transformers.length === 0 && (
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">
                Add transformers to process learning model data
              </p>
            </div>
          )}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-orange-50 p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold text-orange-600">
                {Math.round(
                  learningModels.reduce(
                    (sum, m) => sum + parseInt(m.latency || "0"),
                    0
                  ) / learningModels.length
                )}
                ms
                ...
                <div className="grid grid-cols-2 gap-4 mb-3">
                  ...
                  <div>
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span>
                        {model.costPerToken ? `$${model.costPerToken}` : "N/A"}
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="space-y-6">
          ...
          {localModels.length === 0 && (
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">
                Set up local_model.py to enable private AI
              </p>
            </div>
          )}
      ...
      {selectedTransformer && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-lg w-full">
            <h3 className="text-lg font-semibold mb-4">
              Configure {selectedTransformer.name}
            </h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  defaultValue={
                    selectedTransformer.preprocessing?.join("\n") || ""
                  }
                  className="w-full h-24 p-2 border rounded font-mono text-sm"
              ...
              <div>
                ...
                <textarea
                  defaultValue={
                    selectedTransformer.postprocessing?.join("\n") || ""
                  }
                  className="w-full h-24 p-2 border rounded font-mono text-sm"
      ...
      {selectedLearningModel && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <h3 className="text-lg font-semibold mb-4">
              Configure {selectedLearningModel.name}
            </h3>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    {selectedLearningModel.provider}
                  </div>
                  <div>
                    <span className="text-gray-500">Type:</span>{" "}
                    {selectedLearningModel.type}
                  </div>
                  <div>
                    <span className="text-gray-500">Architecture:</span>{" "}
                    {selectedLearningModel.architecture}
                  </div>
                  <div>
                    <span className="text-gray-500">Parameters:</span>{" "}
                    {selectedLearningModel.parameters}
                  </div>
                  <div>
                    <span className="text-gray-500">Training Data:</span>{" "}
                    {selectedLearningModel.trainingData}
                  </div>
                  <div>
                    <span className="text-gray-500">Status:</span>
                    <span
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">
                      {selectedLearningModel.accuracy
                        ? `${(selectedLearningModel.accuracy * 100).toFixed(
                            1
                          )}%`
                        : "N/A"}
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">
                      {selectedLearningModel.costPerToken
                        ? `$${selectedLearningModel.costPerToken}`
                        : "N/A"}
                    </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedLearningModel.capabilities.map(
                    (capability, index) => (
                      <span
                        key={index}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="url"
                    defaultValue={`https://api.${selectedLearningModel.provider.toLowerCase()}.com/v1/${
                      selectedLearningModel.id
                    }`}
                    className="w-full p-2 border rounded"
                  />
                </div>
